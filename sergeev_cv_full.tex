...
% aligned and centred versions of 'X' col. type
...
\addbibresource{data/pubs.bib}
\setlength\bibitemsep{0.5em}
% Clear pages attribute
\AtEveryBibitem{\clearfield{pages}}
\AtEveryBibitem{\clearfield{issue}}
\AtEveryBibitem{\clearfield{number}}
\AtEveryBibitem{\clearfield{volume}}

% Highlight the name specified by the author+an= attr in the bib file
...
% Reverse numbering of bib items
\makeatletter
...
\defbibheading{underreview}[\refname]{{\textcolor{black}{\subsection*{#1}}}}
\defbibheading{accepted}[\refname]{{\textcolor{black}{\subsection*{#1}}}}
\defbibheading{published}[\refname]{{\textcolor{black}{\subsection*{#1}}}}
...
%----------------------------------------------------------------------------------------
\begin{document}
\keepXColumns  % Needed to keep the tabularx columns stretched over the whole linewidth when using ltablex
...
% \begin{center}
% {\small
% \begin{itemize*}[itemjoin=\quad\quad]
%     \item[\aiADS] \href{https://ui.adsabs.harvard.edu/user/libraries/2IT653szTA-gYw3vyA-9Sw}{NASA ADS:} 200 citations, h-index: 9
%     \item[\aiGoogleScholar] \href{https://scholar.google.co.uk/citations?hl=en&user=_TPM1CcAAAAJ&view_op=list_works&sortby=pubdate}{Google Scholar:} 240 citations, h-index: 9
%     % \item[\aiSemanticScholar] \href{https://www.semanticscholar.org/author/D.-Sergeev/93026299}{Semantic Scholar:} XXX citations, h-index: X
% \end{itemize*}}
% \end{center}
% \begin{refsection}
\nocite{*}
...
Apr 2013 & Numerical modelling of polar mesocyclones generation mechanisms \\ & EGU
