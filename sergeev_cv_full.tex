...
Python libraries (user) & cartopy, cython, iris, matplotlib, numpy, pandas, pyvista, geovista, xarray \\
Python libraries (creator or contributor) & aeolus, cartopy, pyvista \\
